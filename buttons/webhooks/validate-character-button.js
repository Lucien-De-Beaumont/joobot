...
module.exports = {
    ...
    async runInteraction(client, interaction) {
        ...
        interaction.channel.send({ embeds: [embed] })
                ...
                db.query(`INSERT INTO webhook SET nom = '${embed.fields[0].value}', prefix = '${embed.fields[1].value}', iconURL = '${embed.fields[2].value}', date='${date.format(new Date(), 'YYYY-MM-DD HH:mm:ss')}', discordid='${interaction.member.id}'`, function (err, results) {
